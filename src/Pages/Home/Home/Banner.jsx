      ...
      <div className="content">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-12">
          <button className="bg-slate-800 no-underline group cursor-pointer relative shadow-2xl shadow-zinc-900 rounded-full p-px text-xs font-semibold leading-6  text-white inline-block">
            ...
            <div
              className="relative flex justify-center space-x-2 items-center z-10 rounded-full bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500  transition-all duration-300
          hover:scale-105
          hover:shadow-xl py-3.5 px-4 ring-1 ring-white/10 "
            >
          ...
          <button className="bg-slate-800 no-underline group cursor-pointer relative shadow-2xl shadow-zinc-900 rounded-full p-px text-xs font-semibold leading-6  text-white inline-block">
            ...
            <div
              className="relative flex justify-center space-x-2 items-center z-10 rounded-full bg-gradient-to-r from-green-400 via-teal-500 to-blue-500  transition-all duration-300
          hover:scale-105
          hover:shadow-xl py-3.5 px-4 ring-1 ring-white/10 "
            >
